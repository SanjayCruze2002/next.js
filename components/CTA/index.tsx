          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              ...
              <p>
                ...
                Students with O level/Grade 12 would be taking the HPFP (Health Professions Foundation Programme) for 12 months and then admitted into the 5-year MBChB Program
              </p>
              <p className="py-2">
                <strong>5 Years: </strong>
                Students with advanced level or diploma/bachelor’s in science would get an exemption from the foundation program
              </p>
            </motion.div>
            <motion.div
              variants={{
