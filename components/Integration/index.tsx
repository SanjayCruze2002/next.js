            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-1.webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-2..webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-3..webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-4..webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-5..webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-6..webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-7.webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-8.webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-9.webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-10.webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-11.webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={150}
                  height={150}
                  src="/images/brand/alumini-12.webp"
                  alt="Brand"
                />
              </div>
            </motion.div>
